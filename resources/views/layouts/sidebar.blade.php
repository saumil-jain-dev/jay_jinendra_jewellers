...
<aside class="admin-sidebar">
    <div class="admin-sidebar-brand" style="color: white;background: #a70014;">
        ...
        {{-- <img class="admin-brand-logo" src="{{ asset('public/assets/img/logo1.png') }}" width="150" alt="dataxdata Logo"> --}}
        ...
        <ul class="menu">
            ...
            <li class="menu-item @if(Route::is('invoices.*')) active @endif">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="menu-item @if(Route::is('invoices.index') || Route::is('invoices.show') || Route::is('invoices.edit')) active @endif">
