...
@section('content')
    ...
    <section class="admin-content">
        ...
        <div class="container-fluid">
            <form method="POST" id="bill_create" action="{{ route('gst-bill.store') }}">
                @csrf
                <div class="card my-3">
                    <div class="card-body">
                        ...
                        <div class="invoice" style=" padding: 2rem 2rem;">
                            ...
                            <table style="width: 150%; border-collapse: collapse; margin-top: 10px;" id="dynamicTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="border: 1px solid #000;  text-align: center; padding: 5px;">Gross Weight
                                        </th>
                                        <th style="border: 1px solid #000;  text-align: center; padding: 5px;">Net Weight
                                        </th>
                                ...
                                <tbody id="dynamicTableBody">
                                    ...
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][weight]" class="weight"
                                            required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                    ...
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="number" name="data[0][amount]" class="amount"
                                            required readonly /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="number" name="data[0][total_amount]" min="1"
                                            oninput="validateRate(this)" class="total_amount" required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;">
                                    </td>
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 2rem; gap: 10px;">
                                ...
                                <div style=" border: 1px solid #000; border-radius: 8px; padding: 10px; line-height: 1.5;">
                                    ...
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>SILVER:</span> <input type="number" class="number-input" name="weight_silver"
                                            id="silverTotalWeight" readonly>
                                    </div>
                                </div>
                                <!-- Amount Box -->
                                <div
                                ...
                                <div style=" border: 1px solid #000; border-radius: 8px; padding: 10px; line-height: 1.5;">
                                    ...
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>CGST 1.5%:</span> <input type="number" name="cgst" id="totalCgst" readonly />
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>SGST 1.5%:</span> <input type="number" name="sgst" id="totalSgst" readonly />
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        ...
                                        <div style="flex: 1; text-align: right;">
                                            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                                ...
                                                <input type="number" name="final_amount" id="totalAmount" readonly></input>
                                            </div>
                                            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                    ...
                                    <div
                                        ...
                                        <div style="border-bottom: 1px solid #000; width: 85%; position: relative;">
                                            <input type="text"
                                                ...
                                                placeholder="Enter amount in words" id="num_words" name="amt_in_words"
                                                readonly />
                                        </div>
                                    </div>
