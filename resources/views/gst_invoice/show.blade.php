                ...
                <div class="invoice">
                    ...
                    <div style="display: flex;  margin-bottom: 15px;">
                        ...
                        <div style="width: 30%;  line-height: 1.5;">
                            <div style="border: 1px solid #000; border-left: none; border-radius: 8px; padding: 10px;">
                                <div style="text-align: left;"><strong>Invoice No:</strong> {{ $invoice->bill_number }}
                                </div>
                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-top: 10px; border-bottom: 1px solid #000;">
                        <thead>
                            <tr>
                                <th
                                    style="border: 1px solid #000; text-align: center; padding: 5px; min-width: 10px; max-width: 15px;">
                                    No</th>
                                <th style="border: 1px solid #000; text-align: center; padding: 5px; width: 240px;">
                                    Description</th>
                                <th style="border: 1px solid #000; text-align: center; padding: 5px;">Rate</th>
                                <th
                                    style="border: 1px solid #000; text-align: center; padding: 5px; min-width: 15px; max-width: 20px;">
                                    HSN</th>
                                ...
                                <th
                                    style="border: 1px solid #000; text-align: center; padding: 5px; min-width: 20px; max-width: 25px;">
                                    Qty</th>
                        ...
                        <tbody id="dynamicTableBody">
                            ...
                            @if (!empty($particulars))
                                @foreach ($particulars as $index => $particular)
                                    ...
                                    <tr>
                                        <td
                                            style="border-left: 1px solid #000; border-right: 1px solid #000; text-align: center; padding: 5px;">
                                            {{ $count }}
                                        </td>
                                        ...
                                        <td style="border-left: 1px solid #000; border-right: 1px solid #000; text-align: center; padding: 5px;"
                                            ...
                                            @elseif(isset($particular['silver_labour']) && $particular['silver_labour'] !== null)
                                                {{ intval($particular['silver_labour']) . '/gm' }}
                                            @endif
                                        </td>
                                        <td style="border-left: 1px solid #000; border-right: 1px solid #000; text-align: center; padding: 5px;"
                                            contenteditable="true">
                            ...
                            @for ($i = $count; $i <= $totalRows; $i++)
                                <tr>
                                    <td style="border-left: 1px solid #000; border-right: 1px solid #000; padding: 5px;"
