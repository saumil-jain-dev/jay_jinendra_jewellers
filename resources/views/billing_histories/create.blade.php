        ...
        <div class="container-fluid">
                ...
                <div class="card-body">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 20px; font-size: 16px;">
                        ...
                        <div style="width: 18%;">
                            ...
                            <input list="text" name="invoice-number" id="invoice-number" style="width: 100%; font-size:14px; padding: 5px; border: 1px solid #ccc;">
            ...
            <div class="card my-3">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('cash-recept.store') }}">
                    <!-- Table Section -->
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 5px; padding-inline: 3rem;" class="bill_number"></td>
                                    <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 5px; text-align: left;"><input type="date" id="date" name="receipt_date"/></td>
                                    <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 5px; text-align: left;">
                                        <input type="number" value="" style="width: 100%; padding: 5px; border: none; text-align: left; font-size: 14px;" name="amount" id="amount">
                                    </td>
                                    ...
                                    <td style="border-top: 1px solid #000; border-bottom: 1px solid #000; padding: 5px;">
                                        <input type="text" value="" style="width: 100%; padding: 5px; border: none; font-size: 14px;" name="remark">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style=" padding: 5px; text-align: left;"></td>
                                    <td style=" padding: 5px;"><strong>Total: **** <span id="total"></span></strong></td>
                                </tr>
                            </tbody>
                        </table>
                        <!-- Footer Section -->
