...
@section('content')
    ...
    <section class="admin-content">
        ...
        <div class="container-fluid">
            <form method="POST" id="bill_create" action="{{ route('invoices.store') }}">
                @csrf
                <div class="card my-3">
                    <div class="card-body">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 20px; font-size: 16px;">
                            ...
                            <div style="width: 18%;">
                                ...
                                <select name="customer-name" id="customer-name"
                                    style="width: 100%; font-size:14px; padding: 5px; border: 1px solid #ccc;">
                            ...
                            <!-- Last Invoice Number -->
                            <div style="width: 18%;">
                                <label for="last-invoice" style="font-size: 14px; color: #333;">Last Invoice No:</label>
                                <input type="text" id="last-invoice" value="-" disabled
                                    style="width: 100%; padding: 5px; border: 1px solid #ccc; font-size: 14px; text-align:center;">
                            </div>

                            <!-- Total Amount -->
                            <div style="width: 18%;">
                                <label for="total-amount" style="font-size: 14px; color: #333;">Total Amount:</label>
                                <input type="text" id="total-amount" value="-" disabled
                                    style="width: 100%; padding: 5px; border: 1px solid #ccc; font-size: 14px; text-align:center;">
                            </div>
                            ...
                            <div style="width: 18%;">
                                ...
                                <input type="text" id="paid-amount" value="-" disabled
                                    style="width: 100%; padding: 5px; border: 1px solid #ccc; font-size: 14px;text-align:center;">
                            </div>
                            ...
                            <!-- Remaining Amount -->
                            <div style="width: 18%;">
                                <label for="remaining-amount" style="font-size: 14px; color: #333;">Remaining
                                    Amount:</label>
                                <input type="text" id="remaining-amount" value="-" disabled
                                    style="width: 100%; padding: 5px; border: 1px solid #ccc; font-size: 14px; text-align:center;">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="invoice" style=" padding: 2rem 2rem;">
                            <div style="display: flex;  margin-bottom: 15px;">
                                <div
                                    ...
                                    <div style="display: flex; gap: 15px; margin-bottom: 10px; align-items: center;">
                                        ...
                                        <div style="flex: 1; border-bottom: 1px solid #000; position: relative;">
                                            <input type="text"
                                                ...
                                                placeholder="Enter Name" name="party_name" id="party_name" required />
                                    ...
                                    <div style="display: flex; gap: 15px; margin-bottom: 10px; align-items: center;">
                                        ...
                                        <div style="flex: 1; border-bottom: 1px solid #000; position: relative;">
                                            <input type="text"
                                                style="border: none; outline: none; width: 100%; background: transparent; padding: 0; margin: 0;  vertical-align: bottom;"
                                                placeholder="Enter Address" name="party_address" id="party_address"
                                                required />
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: flex; gap: 15px; margin-top: 10px; align-items: center;">
                                        ...
                                        <div style="border-bottom: 1px solid #000; width: 37%; position: relative;">
                                            <input type="text"
                                                ...
                                                placeholder="Enter GST No" name="party_gst" id="party_gst" />
                                        </div>
                                        <strong>Aadhar:</strong>
                                        <div style="border-bottom: 1px solid #000; width: 37%; position: relative;">
                                            <input type="text"
                                                style="border: none; outline: none; width: 100%; background: transparent;  padding: 0; margin: 0;"
                                                placeholder="Aadhar Number" name="party_aadhar" id="party_aadhar" />
                                        </div>
                                        <strong>Mobile:</strong>
                                        <div style="border-bottom: 1px solid #000; width: 37%; position: relative;">
                                            <input type="text"
                                                style="border: none; outline: none; width: 100%; background: transparent;  padding: 0; margin: 0;"
                                                placeholder="Mobile Number" name="party_mobile" id="party_mobile" />
                                        </div>
                                    </div>
                                ...
                                <div style="width: 30%;  line-height: 1.5;">
                                    <div
                                        style="border: 1px solid #000; border-left: none; border-radius: 8px; padding: 10px;">
                                        <div><strong>No:</strong> {{ $newBillNumber }}</div>
                                        <input type="hidden" name="bill_number" value="{{ $newBillNumber }}" />
                                        <div><strong>Date:</strong></div><br>
                                        <input type="date" name="bill_date"  id="date" />
                            ...
                            <table style="width: 150%; border-collapse: collapse; margin-top: 10px;" id="dynamicTable">
                                <thead>
                                    <tr>
                                        <th style="border: 1px solid #000;  text-align: center; padding: 5px;">Description
                                        </th>
                                        ...
                                        <th style="border: 1px solid #000;  text-align: center; padding: 5px;">Labour</th>
                                        <th style="border: 1px solid #000;  text-align: center; padding: 5px;">Gross Amount
                                        </th>
                                ...
                                <tbody id="dynamicTableBody">
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][items]" required />
                                    </td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="number" name="data[0][rate]"  min="1"
                                            class="rate" oninput="validateRate(this)" required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false">7113</td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false">
                                        <select name="data[0][quality]" class="quality">
                                    ...
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][gross_weight]"
                                            class="gross_weight" required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][weight]"
                                            class="weight" required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][qty]" class="qty"
                                            required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][gold_labour]"
                                            class="gold_labour" readonly /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="text" name="data[0][silver_labour]"
                                            class="silver_labour" readonly /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="number" name="data[0][amount]"
                                            class="amount" required readonly /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;"
                                        contenteditable="false"><input type="number" name="data[0][total_amount]" min="1" oninput="validateRate(this)"
                                            class="total_amount" required /></td>
                                    <td style="border: 1px solid #000; border-top:none; text-align: center; padding: 5px;">
                                    </td>
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 2rem; gap: 10px;">
                                <!-- Weight Box -->
                                <div
                                    style=" border: 1px solid #000; border-radius: 8px; padding: 10px; line-height: 1.5;">
                                    <strong>WEIGHT</strong>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>999:</span> <input type="number" class="number-input" name="weight_999"
                                            id="999TotalWeight" readonly>
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>916:</span> <input type="number" class="number-input" name="weight_916"
                                            id="916TotalWeight" readonly>
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>KDM:</span> <input type="number" class="number-input" name="weight_kdm"
                                            id="kdmTotalWeight" readonly>
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>18K:</span> <input type="number" class="number-input" name="weight_18k"
                                            id="18kTotalWeight" readonly>
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>SILVER:</span> <input type="number" class="number-input"
                                            name="weight_silver" id="silverTotalWeight" readonly>
                                    </div>
                                </div>
                                <!-- Amount Box -->
                                <div
                                    ...
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>Total:</span> <span class="gross_amount"></span>
                                ...
                                <div
                                    ...
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>CGST 1.5%:</span> <input type="number" name="cgst" id="totalCgst"
                                            readonly />
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <span>SGST 1.5%:</span> <input type="number" name="sgst" id="totalSgst"
                                            readonly />
                                    </div>
                                    <div style="display: flex; justify-content: space-between;">
                                        <strong><span>Total:</span> <input type="number" name="gst_total" id="totalGst"
                                                readonly />
                                    </div>
                                </div>
                                <!-- Payment Box -->
                                <div
                                    style=" border: 1px solid #000; border-radius: 8px; padding: 10px; line-height: 1.8; font-family: Arial, sans-serif;">
                                    ...
                                    <div style="display: flex; justify-content: space-between; margin-top: 10px;">
                                        <div style="flex: 1; text-align: left;">
                                            <div style="display: flex; align-items: center; margin-bottom: 8px;">
                                                ...
                                                <input type="text"
                                                    style="width: 60px; border: none; border-bottom: 1px solid #000; background: transparent; outline: none;"
                                                    name="old_gold" id="old_gold" />
                                            </div>
                                            <div style="display: flex; align-items: center; margin-bottom: 8px;">
                                                <div style="width: 100px; text-align: left;">OLD SILVER:</div>
                                                <input type="text"
                                                    style="width: 60px; border: none; border-bottom: 1px solid #000; background: transparent; outline: none;"
                                                    name="old_silver" id="old_silver" />
                                            </div>
                                        ...
                                        <div style="flex: 1; text-align: right;">
                                            <div
                                                ...
                                                <input type="number" name="final_amount" id="totalAmount"
                                                    readonly></input>
                                            </div>
                                            <div
                                                style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                            ...
                                            <div style="display: flex; justify-content: space-between;">
                                                ...
                                                <input type="text"
                                                    style="width: 60px; border: none; border-bottom: 1px solid #000; background: transparent; outline: none;"
                                                    name="online_amount" id="online_amount" />
                                            </div>
                                        </div>
                            ...
                            <div style="margin-top: 20px; display: flex; justify-content: space-between;">
                                ...
                                <div style="width: 70%; line-height: 1.5;">
                                    <div
                                        ...
                                        <div style="border-bottom: 1px solid #000; width: 85%; position: relative;">
                                            <input type="text"
                                                ...
                                                placeholder="Enter amount in words" id="num_words" name="amt_in_words" readonly />
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div style="border-bottom: 1px solid #000; width: 85%; position: relative;">
                                            <select
                                                style="border: none; outline: none; width: 100%; background: transparent;  padding: 0; margin: 0; height:20px;"
                                                name="guarantor_id" id="guarantor_id">
                                    ...
                                    <div
                                        ...
                                        <div style="border-bottom: 1px solid #000; width: 85%; position: relative;">
                                            <input type="text"
                                                ...
                                                placeholder="Enter remarks" name="remark" id="remark" />
                                        </div>
                                    </div>
                                ...
                                <div style="width: 28%; display: flex; flex-direction: column; gap: 10px;">
                                    <table style="width: 100%; border-collapse: collapse; ">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; text-align: center; "><input type="number"
                                                    name="given_amount" id="given_amount" /></td>
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; text-align: center; "><input type="number"
                                                    name="pending_amount" id="pending_amount" /></td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
                                        <tr>
                                            ...
                                            <td style="border: 1px solid #000; text-align: center; "><input
                                                    id="totalAmounts" name="totalAmounts" type="text"></td>
                                        </tr>
                                    </table>
        ...
        function updateWeights() {
            ...
            document.querySelectorAll('#dynamicTableBody tr').forEach((row) => {
                ...
                const weight = parseFloat(row.querySelector('.weight')?.value) ||
                    0; // Get the weight or default to 0
